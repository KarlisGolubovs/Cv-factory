...
const PdfDocument: React.FC<PdfDocumentProps> = ({
    ...
    <Document>
        <Page style={{ fontFamily: 'Roboto', padding: 24, backgroundColor: 'lightgray' }}>
            <View style={{ backgroundColor: 'lightgray', padding: 12, borderRadius: 8 }}>
                ...
                <View style={{ marginBottom: 12 }}>
                    ...
                    {jobExperiences.map((experience, index) => (
                        <View key={`job-${index}`} style={{ marginBottom: 12, marginLeft: 16 }}>
                ...
                <View>
                    ...
                    {educations.map((education, index) => (
                        <View key={`education-${index}`} style={{ marginBottom: 12, marginLeft: 16 }}>
                            <Text style={{ fontSize: 18, fontWeight: 'bold', marginBottom: 4 }}>
                                Degree: {education.degree} - {education.school}
                            </Text>
                            <Text>Date: {education.educationDate}</Text>
